   ...
   internal class GreenConstructNode : GreeenCallableDeclarationNode
    {
        ...
        public GreenConstructNode(Interval interval, ProtectionLevel protectionLevel, GreenTypeNode returnType, GreenBlockNode body) 
            : base(interval, protectionLevel, returnType,null, body,NodeType.ConstructorNode)
        {
            ChildCount = 3;
